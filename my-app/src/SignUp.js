...
const REGION = process.env.REACT_APP_REGION; // e.g., 'us-east-1'
const CLIENT_ID = process.env.REACT_APP_CLIENT_ID; // e.g., 'XXXXXX'
...
function SignUp({ onAuthenticated }) {
  ...
  const handleConfirmSignUp = async () => {
    try {
      ...
      setMessage(
        "Signed in successfully! Now you can access protected resources."
      );
